...
export const COPY = {
  ...
  welcome: (settings: string) =>
    [
      ...
      '',
      'مرحبًا بعودتك إلى بوت "آية". تصلك آية واحدة كل يوم بإذن الله، مع مراجعة لما حفظتَه لتثبيته.',
      '',
  ...
  botDescription: [
    ...
    '• تصلك كل يوم آية واحدة، ومعها آيات سابقة من السورة نفسها للمراجعة (تختار عددها).',
    '• ولتثبيت ما حفظتَه، تُراجع كل يوم بضع آيات مما أتممتَه سابقًا، على التدوير، فلا يتفلّت القديم (تضبطها بأمر /review).',
