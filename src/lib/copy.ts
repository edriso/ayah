...
export const COPY = {
  ...
  surahPrompt:
    'اختر السورة التي تريد أن تبدأ بها.\n' +
  ...
  // The /review card: two knobs. القريبة = the previous ayat of the SAME surah
  // shown with today's new ayah. التثبيت = previously-memorized ayat revisited
  ...
  // Telegram caps the description at 512 characters; keep it under that or the
  // setMyDescription call fails on boot and the live text never updates.
  botDescription: [
    'السلام عليكم ورحمة الله 🌿',
    'بوت "آية" يصحبك مع كتاب الله آيةً آية، لتحفظها أو تتدبّر تفسيرها:',
    '• كل يوم آية، ومعها آيات من سورتها للمراجعة، ولا تتقدّم حتى تضغط «أتممتُها»، فلا تفوتك آية وإن غِبتَ أيامًا.',
    '• ولتثبيت ما أتممتَه تصلك يوميًا مراجعة على التدوير من آياتك السابقة (بأمر /review).',
    '• تلاوة صوتية (/reciter)، وتفسير بصمت برابط لقراءته كاملًا من مصدر موثوق (/tafsir).',
    '• تختار السورة والترتيب (من الناس للحفظ أو من الفاتحة)، ووقتك وأيامك، ولك أن تأخذ راحة وتعود.',
